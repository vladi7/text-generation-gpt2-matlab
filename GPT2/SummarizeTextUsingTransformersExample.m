...
score = bleuEvaluationScore(tokenizedDocument(summary),tokenizedDocument("My girlfriend pretended to be pregnant so that I wouldn't leave her and go to college."),'NgramWeights',[0.75 0.25 0.25])
